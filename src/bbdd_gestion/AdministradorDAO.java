...
public class AdministradorDAO {
	...
	public static Administrador loadAdministradorByORMID(PersistentSession session, int id_Usuario) throws PersistentException {
		try {
			return (Administrador) session.load(bbdd_gestion.Administrador.class, new Integer(id_Usuario));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Administrador getAdministradorByORMID(PersistentSession session, int id_Usuario) throws PersistentException {
		try {
			return (Administrador) session.get(bbdd_gestion.Administrador.class, new Integer(id_Usuario));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Administrador loadAdministradorByORMID(PersistentSession session, int id_Usuario, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Administrador) session.load(bbdd_gestion.Administrador.class, new Integer(id_Usuario), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Administrador getAdministradorByORMID(PersistentSession session, int id_Usuario, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Administrador) session.get(bbdd_gestion.Administrador.class, new Integer(id_Usuario), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryAdministrador(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From bbdd_gestion.Administrador as Administrador");
		if (condition != null)
	...
	public static Administrador createAdministrador() {
		return new bbdd_gestion.Administrador();
	}
	
	public static boolean save(bbdd_gestion.Administrador administrador) throws PersistentException {
		try {
			bbdd_gestion.ProjectMDS2PersistentManager.instance().saveObject(administrador);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(bbdd_gestion.Administrador administrador) throws PersistentException {
		try {
			bbdd_gestion.ProjectMDS2PersistentManager.instance().deleteObject(administrador);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(bbdd_gestion.Administrador administrador)throws PersistentException {
		try {
			bbdd_gestion.Correo[] lEntradas = administrador.entrada.toArray();
			for(int i = 0; i < lEntradas.length; i++) {
				lEntradas[i].setRecibe(null);
			}
			bbdd_gestion.Correo[] lSalidas = administrador.salida.toArray();
	...
	public static boolean deleteAndDissociate(bbdd_gestion.Administrador administrador, org.orm.PersistentSession session)throws PersistentException {
		try {
			bbdd_gestion.Correo[] lEntradas = administrador.entrada.toArray();
			for(int i = 0; i < lEntradas.length; i++) {
				lEntradas[i].setRecibe(null);
	...
	public static boolean refresh(bbdd_gestion.Administrador administrador) throws PersistentException {
		try {
			bbdd_gestion.ProjectMDS2PersistentManager.instance().getSession().refresh(administrador);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(bbdd_gestion.Administrador administrador) throws PersistentException {
		try {
			bbdd_gestion.ProjectMDS2PersistentManager.instance().getSession().evict(administrador);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
