...
public class UsuarioDAO {
	...
	public static Usuario loadUsuarioByORMID(PersistentSession session, int id_Usuario) throws PersistentException {
		try {
			return (Usuario) session.load(bbdd_gestion.Usuario.class, new Integer(id_Usuario));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Usuario getUsuarioByORMID(PersistentSession session, int id_Usuario) throws PersistentException {
		try {
			return (Usuario) session.get(bbdd_gestion.Usuario.class, new Integer(id_Usuario));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Usuario loadUsuarioByORMID(PersistentSession session, int id_Usuario, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Usuario) session.load(bbdd_gestion.Usuario.class, new Integer(id_Usuario), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Usuario getUsuarioByORMID(PersistentSession session, int id_Usuario, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Usuario) session.get(bbdd_gestion.Usuario.class, new Integer(id_Usuario), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryUsuario(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From bbdd_gestion.Usuario as Usuario");
		if (condition != null)
	...
	public static Usuario createUsuario() {
		return new bbdd_gestion.Usuario();
	}
	
	public static boolean save(bbdd_gestion.Usuario usuario) throws PersistentException {
		try {
			bbdd_gestion.ProjectMDS2PersistentManager.instance().saveObject(usuario);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(bbdd_gestion.Usuario usuario) throws PersistentException {
		try {
			bbdd_gestion.ProjectMDS2PersistentManager.instance().deleteObject(usuario);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(bbdd_gestion.Usuario usuario)throws PersistentException {
		if (usuario instanceof bbdd_gestion.Cliente) {
			return bbdd_gestion.ClienteDAO.deleteAndDissociate((bbdd_gestion.Cliente) usuario);
		}
		
		if (usuario instanceof bbdd_gestion.Administrador) {
			return bbdd_gestion.AdministradorDAO.deleteAndDissociate((bbdd_gestion.Administrador) usuario);
		}
		
		try {
			bbdd_gestion.Correo[] lEntradas = usuario.entrada.toArray();
			for(int i = 0; i < lEntradas.length; i++) {
				lEntradas[i].setRecibe(null);
			}
			bbdd_gestion.Correo[] lSalidas = usuario.salida.toArray();
	...
	public static boolean deleteAndDissociate(bbdd_gestion.Usuario usuario, org.orm.PersistentSession session)throws PersistentException {
		if (usuario instanceof bbdd_gestion.Cliente) {
			return bbdd_gestion.ClienteDAO.deleteAndDissociate((bbdd_gestion.Cliente) usuario, session);
		}
		
		if (usuario instanceof bbdd_gestion.Administrador) {
			return bbdd_gestion.AdministradorDAO.deleteAndDissociate((bbdd_gestion.Administrador) usuario, session);
		}
	...
	public static boolean refresh(bbdd_gestion.Usuario usuario) throws PersistentException {
		try {
			bbdd_gestion.ProjectMDS2PersistentManager.instance().getSession().refresh(usuario);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(bbdd_gestion.Usuario usuario) throws PersistentException {
		try {
			bbdd_gestion.ProjectMDS2PersistentManager.instance().getSession().evict(usuario);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
