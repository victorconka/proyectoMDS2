...
ALTER TABLE Foto DROP FOREIGN KEY FKFoto99812;
...
CREATE TABLE Mapa (Id_mapa int(11) NOT NULL AUTO_INCREMENT, Longitud varchar(255), Latitud varchar(255), CodigoPostal varchar(255), PRIMARY KEY (Id_mapa)) ENGINE=InnoDB CHARACTER SET UTF8;
CREATE TABLE Inmueble (Id_Inmueble int(11) NOT NULL AUTO_INCREMENT, CodigoPostalId_CodigoPostal int(11), ProvinciaId_provincia int(11), MunicipioId_Municipio int(11), LinkFoto varchar(255), Direccion varchar(255), PRIMARY KEY (Id_Inmueble)) ENGINE=InnoDB CHARACTER SET UTF8;
CREATE TABLE Foto (Id_foto int(11) NOT NULL AUTO_INCREMENT, CasaInmuebleId_Inmueble int(11), InmuebleId_Inmueble int(11), LinkFoto varchar(255), PRIMARY KEY (Id_foto)) ENGINE=InnoDB CHARACTER SET UTF8;
...
CREATE TABLE Correo (Id_Correo int(11) NOT NULL AUTO_INCREMENT, CasaInmuebleId_Inmueble int(11), UsuarioId_Usuario2 int(11), UsuarioId_Usuario int(11), Fuente varchar(255), Destinatario varchar(255), Asunto varchar(255), Texto varchar(255), PRIMARY KEY (Id_Correo)) ENGINE=InnoDB CHARACTER SET UTF8;
...
CREATE TABLE Casa (Id_casa int(11) NOT NULL, Precio double NOT NULL, Superficie double, Habitaciones int(11) NOT NULL, Banios int(11) NOT NULL, Tipo varchar(255), LinkMapa varchar(255), Estado varchar(255), Accion varchar(255), NumVisitas int(11) NOT NULL, NumFavoritos int(11) NOT NULL, Visible varchar(255), DCorta varchar(255), DLarga varchar(255), InmuebleId_Inmueble int(11) NOT NULL, ClienteUsuarioId_Usuario int(11), MapaId_mapa int(11), PRIMARY KEY (InmuebleId_Inmueble)) ENGINE=InnoDB CHARACTER SET UTF8;
...
ALTER TABLE Foto ADD INDEX FKFoto99812 (InmuebleId_Inmueble), ADD CONSTRAINT FKFoto99812 FOREIGN KEY (InmuebleId_Inmueble) REFERENCES Inmueble (Id_Inmueble);
